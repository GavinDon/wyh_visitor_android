 ...
 */
public class BottomSheetBehavior3<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior3() {
    }

    public BottomSheetBehavior3(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onLayoutChild(
        ...
        //减去箭头的高度
        parentHeight = parent.getHeight() - dp2px(38);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull BottomSheetBehavior3<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link BottomSheetBehavior3#SAVE_PEEK_HEIGHT}, {@link
         * BottomSheetBehavior3#SAVE_FIT_TO_CONTENTS}, {@link BottomSheetBehavior3#SAVE_HIDEABLE}, {@link
         * BottomSheetBehavior3#SAVE_SKIP_COLLAPSED}. It is as if {@link BottomSheetBehavior3#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link SavedState(Parcelable, BottomSheetBehavior3 )} instead.
         */
        @Deprecated
    ...
    /**
     * A utility function to get the {@link BottomSheetBehavior3} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehavior3}.
     * @return The {@link BottomSheetBehavior3} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehavior3<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof BottomSheetBehavior3)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheetBehavior");
        }
        return (BottomSheetBehavior3<V>) behavior;
    }
